...
namespace VHierarchy
{
    public static class VHierarchy
    {
        ...
        static void Init()
        {
            void loadData()
            {
                data = AssetDatabase.LoadAssetAtPath<VHierarchyData>(EditorPrefs.GetString("vHierarchy-dataLastFoundAtPath"));
                ...
                if (data) { EditorPrefs.SetString("vHierarchy-dataLastFoundAtPath", data.GetPath()); return; }


                data = ScriptableObject.CreateInstance<VHierarchyData>();
                AssetDatabase.CreateAsset(data, GetScriptPath("vHierarchy").ParentPath().CombinePath("vHierarchy Data.asset"));
